...
CPPFLAGS := -DASSEMBLER -DDEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
...
CPPSRC := main.cpp canary.cpp list.cpp string_functions.cpp
